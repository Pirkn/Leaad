          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >
                ...
                Our AI handles the heavy lifting while you focus on closing
                deals.
              </motion.p>
            </motion.div>
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent className="px-0 pb-0">
                    <p className="text-base text-gray-600 leading-relaxed tracking-tight">
                      ...
                      Reddit's guidelines and uses only publicly available data.
                      We don't automate posting, messaging, or any actions that
                      could violate terms of service. Our tools are designed for
                      research and lead discovery, not automation of social
                      media actions.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent className="px-0 pb-0">
                    <p className="text-base text-gray-600 leading-relaxed tracking-tight">
                      ...
                      ideas and templates. The AI studies what makes content go
                      viral in your niche and helps you create posts that are
                      more likely to engage your audience and generate leads.
                      You maintain full control over the final content.
                    </p>
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
