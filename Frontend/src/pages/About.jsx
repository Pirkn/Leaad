          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md mb-8">
              ...
              <p className="text-gray-600 mb-6">
                We're revolutionizing digital marketing by combining
                cutting-edge AI technology with proven marketing strategies. Our
                platform helps businesses create compelling content that
                resonates with their audience and drives real results.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Leveraging the latest in artificial intelligence to create
                  content that captures attention and drives engagement.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
